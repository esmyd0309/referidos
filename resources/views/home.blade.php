            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        @if($users->activo == 1)
                        <a class="navbar-brand" href="{{ route('vicidial.index') }}"> <img src="http://192.168.1.107/referidos/public/img/log.png" width="100" height="100" class="rounded-pill" title="Sistemas: Procesos que ayudan a la automatizacion de la empresa"><B>SISTEMAS</B></a>
                        @else
                        <div class="col-sm">
                        </div>
                        @endif
