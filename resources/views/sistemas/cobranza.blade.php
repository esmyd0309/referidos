        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="card-body" style="color:red;">
                    {!! Form::open(['route' => 'vicidial.precobranza']) !!}

                    <div class="form-group">

                        {{ form::label('lotes', 'BUSCAR ESTADOS CERRADOS DE LOS LOTES DE COBRANZA ') }}
                        ...
                        {{ form::label('lotes', 'SACAR ESTADOS CERRADOS DEL : ') }}
                        ...
                        <div class="form-group">
                            ...
                            <a  href="{{ route('vicidial.index') }}" class="btn btn-success btn-sm active" role="button"> Volver </a>
                        </div>
                    {!! Form::close() !!}
