            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row ">
                        ...
                        {!! Form::open(['route' => 'vicidial.store']) !!}
                      ...
                      <hr>
                        ...
                        <p>UPDATE vicidial_list SET STATUS='lote' 
                            ...
                            AND NOT STATUS IN ('SALE','SALET','VI','VTI','DNC','NAP','CALLBK')</p>
                           <center> <a  href="{{ route('ventas') }}" class="btn btn-success btn-sm active" role="button"> Volver </a></center>
                    </div>
                    </div>
