...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'troncal1' => [
            'driver' => 'mysql',
            'host' => env('troncal1_HOST', '192.168.1.4'),
            'port' => env('troncal1_PORT', '3306'),
            'database' => env('troncal1_DATABASE', 'forge'),
            'username' => env('troncal1_USERNAME', 'forge'),
            'password' => env('troncal1_PASSWORD', ''),
            'unix_socket' => env('troncal1_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'logpredictivo' => [
            'driver' => 'sqlsrv',
            'host' => env('predictivo_HOST', '192.168.1.7'),
            'port' => env('predictivo_PORT', '1433'),
            'database' => env('predictivo_DATABASE', 'Predictivos'),
            'username' => env('predictivo_USERNAME', 'siii'),
            'password' => env('predictivo_PASSWORD', '1234'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
